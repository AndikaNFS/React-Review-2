...
// DI sini kita mengatahui bahwa nantinya CardMovie akan menerima
// suatu data dari ListMovie
// menerima props
const CardMovie = (props) => {
    ...
    return (
        ...
        <Card className="boxy">
            ...
            >
                {/* Card ada 2 tipe yang bisa dimasukan sebagai isinya:
                ...
                >
                    ...
                    JSON kit lebih dari 10, maka kita bagi 2
                    
                    Precision untuk menyatakan ratingnya itu dibuatkan gambarnya hingga per
                    seberapanya? (0.1 = sampai 1 koma dibelakang angka)
                     */}
                    <Rating
                    ...
                    <Typography variant="body2">
                        Releast date: {props.movie.release_date}
                    </Typography>
